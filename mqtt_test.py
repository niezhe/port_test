...
# -*- coding: utf-8 -*-
# author： jenny
# datetime： 2020/11/21 16:53 
# File ：mqtt_por_test.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
# @click.command()
# @click.option('--c', '-p', default=80, type=click.INT, help='Tcp port')
...
if __name__ == '__main__':
    print("**********************MQTT测试程序***************************")
    host = "20.mqtt.tocoding.com"
    port = 8883
    count = 10
    timeout = 1
    report = False
    cli(host,port,count,timeout,report)
